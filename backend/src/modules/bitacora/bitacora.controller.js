...
export const registrarProgreso = async (req, res) => {
    try {
        ...
        const result = await bitacoraService.registrarProgreso(id_usuario, req.body, req.timezone);
...
export const obtenerRegistrosPorPeriodo = async (req, res) => {
    try {
        ...
        const result = await bitacoraService.obtenerRegistrosPorPeriodo(id_usuario, periodo, req.timezone);
